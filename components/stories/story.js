    ...
    !isHidden && (
      <div key={objectID} className="story">
        ...
        <div className="story-author">
          <span Style="color: #828282">by</span> {author}
        </div>
        <div className="story-created-at">
          {moment(moment(created_at).format('MMDDYYYY'), 'MMDDYYYY').fromNow()}
        </div>
        <div className="story-hide" onClick={() => setIsHidden(!isHidden)}>
          <span Style="color: #828282">[</span> hide{' '}
